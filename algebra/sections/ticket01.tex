...
\begin{Remark}{}{}
    Если матрица $A$ элементарными преобразованиями строк приведена к ступенчатому виду с $r$ ненулевыми строками (окаймлённая единичная матрица $\begin{pmatrix} E_r & * \\ 0 & 0 \end{pmatrix}$), то количество единиц на диагонали равно $r = \mathrm{rk}(A)$.
\end{Remark}
...
\begin{Definition}{Тензорный ранг}{}
    \emph{Тензорный ранг нуля} равен $0$. \emph{Тензорный ранг единицы} матрицы ранга $1$ равен $1$. В общем случае \emph{тензорным рангом} матрицы $A$ называется
    \[
        \mathrm{rk}_{\otimes}(A) = \min\bigl\{r \mid A = A_1 + \cdots + A_r,\; \mathrm{rk}(A_i) = 1\bigr\}.
    \]
\end{Definition}
...
\textbf{$\mathrm{rk}_{\otimes}(A) \geq \mathrm{rk}(A)$.} Каждое слагаемое $A_i$ ранга $1$ вносит не более $1$ в ранг суммы:
\[
