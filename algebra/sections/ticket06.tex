...
\begin{proof}
    ...
    \begin{enumerate}
        \item $H_0 < G \Leftrightarrow H_0$~--- подгруппа 
        ...
        \item $\forall H < G, M \subset H \Rightarrow H \subset H_0$
...
\begin{Example}{Группа симметрий правильного n-угольника}{}
    ...
    \[   
    D_n = \{ R_i, S-i \ \ | \ \ 0 \le i \le n-1 \}
    \]

    $R_k = R^k_1 \Rightarrow R_i \circ R_j = R_{i+j}$

    Из геометрии можно увидеть: $S_i \circ S-j = R_{i-j}$
...
В общем случае $gh != hg$, поэтому в нашем случае:
...
\begin{enumerate}
    ...
    \[ g != e \Rightarrow ord(g) != 1, ord(g) = P \Rightarrow ord(g) = |G| \Rightarrow\]
...
\[ g_1(Hg_2)H = g_1g_2H \]
\[ (Hg_2)H = g2H \Leftrightarrow Hg_2 = g_2H \]
...
\begin{Proposition}{}{}
    ...
    \begin{enumerate}
        ...
        \item $\forall \ \ g \in G, \ \ \forall h in H ghg^{-1} \in H$~--- сопряженный к $h$ при помощи $g$ содержится в $H$.
...
\begin{proof}
    ...
    \[ ghg^{-1} \in H \Rightarrow gHg^{-1} \in H \]
