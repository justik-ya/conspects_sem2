...
\begin{proof}
	...
	\begin{align*}
		...
		&= \ln(1+t)-\ln(1-t) \\
		&= 2t+\frac{2t^3}{3}+\frac{2t^5}{5}+\cdots+r_k(t),
	\end{align*}
	\emph{где $r_k(t)$ — остаток (в форме Лагранжа/интегральной и т.п.), $k>10$.}
	
	\[
	\frac12\,\ln\!\Bigl(\frac{1+t}{1-t}\Bigr)
	= \frac12\Bigl(2t+\frac{2t^3}{3}+\frac{2t^5}{5}+\cdots+r_k(t)\Bigr),
	\qquad k>10.
	\]
	...
	\begin{align*}
		...
		&= t^{-1}\cdot\frac12\Bigl(2t+\frac{2t^3}{3}+\cdots+r_k(t)\Bigr)-1 \\
		&= \underbrace{\frac13\,t^2+\frac15\,t^4+\cdots+\frac{2\,r_k(t)}{t}}_{> 0}.
	\end{align*}
	...
	\text{Кроме того,}\quad
	0<d_n-d_{n+1}
	=\frac13\Bigl(t^2+\frac35t^4+\frac57t^6+\cdots\Bigr)+\frac23\,\frac{r_k(t)}{t}
	<\frac13\Bigl(t^2+t^4+\cdots+t^{2(k-1)}\Bigr)+\frac23\,t\, r_k(t).
	\]
	\emph{(Просто грубо заменили дроби $\frac{3}{5},\frac{5}{7},\dots<1$.)}
	...
	\qquad
	\frac{r_k(t)}{t}\xrightarrow[k\to\infty]{}0
	\quad (\text{при фиксированном } t,\ |t|<1).
	\]
	
	\[
	\text{Следовательно}\qquad
	0<d_n-d_{n+1}<\frac13\cdot\frac{t^2}{1-t^2}
	...
	\begin{align*}
		...
		&=4d_n-2d_{2n}+\ln n-\ln2-\ln(2n+1)+o(1)\\
...
\begin{proof} 
	...
	\medskip
	\textbf{Положим} $x:=\dfrac{a}{\alpha}$, \quad $\alpha:=\dfrac{1}{p}$, \quad
